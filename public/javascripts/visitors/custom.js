$(document).ready(function() {
    ...
    $('#send').bind({
        click: function(event) {
            ...
            $('#send').html("").css('background-position','center').css('background-repeat','no-repeat').css('background-size','34px 28px').css('background-image','url(/images/ajax_loader_metal_512.gif)');
